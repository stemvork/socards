...
menu_card = [
("Classic", 'Draw a card. Everyone then answers the same question. The person\
    whose turn it is then picks the best answer and gives him/her the card.'), 
("Popcorn", "Have everyone pick a different question each, and then take turns\
answering."), 
("Solo" ,"Do this on your own. Use the questions as writing prompts for a\
journal entry or simply a means of personal reflection."), ("If I were you"
,"Have everyone else answer your question as if they were you. The person"\
"whose answer is closest to the truth wins the round."), ("Lightning round",
