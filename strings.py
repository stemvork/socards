cards = [ '''Describe a moment that made you feel like a real grown-up.'''
        ...
        , '''When you sit next to someone on a plane, what do you think goes through their mind?'''
        , '''Come up with a new Olympic sport in which you would definitely medal.'''
...
, '''Have everyone pick a different question each, and then take turns answering.'''
, '''Do this on your own. Use the questions as writing prompts for a journal entry or simply a means of personal reflection.'''
, '''Have everyone else answer your question as if they were you. The person whose answer is closest to the truth wins the round.'''
